...
export const ActivateModalProvider = ({ children }: { children: ReactNode }) => {
  ...
  const GOOGLE_SHEET_WEBHOOK = "https://script.google.com/macros/s/AKfycbwLuPfR9E39P4t5Ie_qkmwNVdKD_JuBKxLdKroPMA-cxP1jbtCMvHouOdd-pkglHAZvpg/exec";
  ...
  return (
    <ActivateModalContext.Provider value={{ openModal }}>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="linkedin-theme sm:max-w-md border-border !p-0 overflow-hidden" style={{ background: 'hsl(216 35% 10%)', color: 'white' }}>
          {step === "confirm" ? (
