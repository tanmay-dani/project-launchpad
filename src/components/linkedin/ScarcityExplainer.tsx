        ...
        <ScrollReveal>
          <div className="bg-gradient-card rounded-2xl p-8 md:p-10 border border-border">
            <div className="flex items-center gap-3 mb-5">
              <HelpCircle className="w-6 h-6 text-success flex-shrink-0" />
              <h3 className="text-xl md:text-2xl font-bold text-foreground">
                "Wait... ₹399 for ₹7,500 worth? What's the catch?"
              </h3>
            </div>
            <p className="text-muted-foreground mb-4 leading-relaxed">
              <span className="text-foreground font-semibold">No catch. Here's the honest truth:</span>
            </p>
            <p className="text-muted-foreground mb-4 leading-relaxed">
            ...
            <div className="bg-destructive/10 border border-destructive/25 rounded-xl p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">
                  ⚠️ Only <span className="text-destructive font-bold">{vouchersLeft} vouchers</span> left in this batch
                </p>
                <p className="text-xs text-muted-foreground mt-0.5">
                  When they're gone, next batch will be ₹699. We can't control the supply.
                </p>
              </div>
            </div>
          </div>
