      ...
      <div className="container max-w-4xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-12">
            <p className="text-sm font-semibold text-success uppercase tracking-widest mb-3">The Irresistible Offer</p>
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              Here's Everything You Get <span className="text-success">Today</span>
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              We didn't just make it cheap — we made it a <span className="text-foreground font-semibold">no-brainer.</span>
            </p>
          </div>
        </ScrollReveal>
            ...
            {stackItems.map((item, i) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className={`text-sm md:text-base block ${item.isBonus ? "text-success font-semibold" : "text-foreground"}`}>
                      {item.component}
                    </span>
        ...
        {/* The Grand Reveal — Price Anchoring */}
        <ScrollReveal delay={0.2}>
          <div className="text-center mt-10 space-y-3">
            ...
            <p className="text-6xl md:text-8xl font-bold text-success">₹399</p>
            <p className="text-muted-foreground">One-time payment · 3 months · Your own account</p>
            <p className="text-success font-bold text-lg mt-4">That's ₹4.4/day for a career transformation.</p>
