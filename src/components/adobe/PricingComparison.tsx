      ...
      <div className="container max-w-5xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              Unbeatable <span className="text-gradient">Savings</span>
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Compare our exclusive offer with Adobe's official pricing
            </p>
          </div>
        </ScrollReveal>
          ...
          <ScrollReveal direction="left">
            <div className="bg-gradient-card rounded-xl p-4 border border-border relative overflow-hidden h-full">
              <div className="relative">
                ...
                <p className="text-xs text-muted-foreground mt-1">/4 months</p>
                
                <div className="mt-4 space-y-1.5">
                  {features.slice(0, 4).map((feature) => (
                    <div key={feature.name} className="flex items-center gap-1.5 text-muted-foreground">
                      <Check className="w-3 h-3 flex-shrink-0" />
                      <span className="text-xs truncate">{feature.name.replace("Adobe ", "")}</span>
                    </div>
                  ))}
          ...
          <ScrollReveal direction="right">
            <div className="bg-gradient-card rounded-xl p-4 border-2 border-primary/40 relative overflow-hidden shadow-glow h-full">
              ...
              <div className="relative">
                ...
                <p className="text-2xl font-bold text-gradient">₹599</p>
                <p className="text-xs text-muted-foreground mt-1">/4 months</p>
                ...
                <div className="mt-4 space-y-1.5">
                  {features.slice(0, 4).map((feature) => (
                    <div key={feature.name} className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs text-foreground truncate">{feature.name.replace("Adobe ", "")}</span>
                    </div>
                  ))}
                  <p className="text-xs text-success">+6 more</p>
                </div>
              </div>
            </div>
          </ScrollReveal>
            ...
            <div className="bg-gradient-card rounded-2xl p-8 border border-border relative overflow-hidden h-full">
              ...
              <div className="relative">
                ...
                <div className="flex items-baseline gap-2 mb-6">
                  <span className="text-5xl font-bold text-muted-foreground line-through">₹6,000</span>
                  <span className="text-muted-foreground">/4 months</span>
                </div>
                <p className="text-sm text-muted-foreground mb-8">₹1,500/month × 4 months</p>
                
                <div className="space-y-3">
                  {features.slice(0, 5).map((feature) => (
                    <div key={feature.name} className="flex items-center gap-3 text-muted-foreground">
                      <Check className="w-5 h-5" />
                      <span>{feature.name}</span>
                    </div>
                  ))}
                  <p className="text-sm text-muted-foreground pt-2">+ 5 more apps</p>
                </div>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal direction="right">
            <div className="bg-gradient-card rounded-2xl p-8 border-2 border-primary/40 relative overflow-hidden shadow-glow h-full">
              ...
              <div className="relative">
                ...
                <div className="flex items-baseline gap-2 mb-6">
                  <span className="text-5xl font-bold text-gradient">₹599</span>
                  <span className="text-muted-foreground">/4 months</span>
                </div>
                <p className="text-sm text-success mb-8">One-time payment • Full access</p>
        ...
        <ScrollReveal delay={0.2}>
          <div className="mt-8 md:mt-12 bg-gradient-card rounded-2xl p-6 md:p-8 border border-success/30 text-center">
            ...
            <p className="text-3xl md:text-6xl font-bold text-success">₹5,400</p>
            <p className="text-muted-foreground mt-2 text-sm md:text-base">That's 90% off the official price!</p>
          </div>
        </ScrollReveal>
      </div>
    </section>
